...
public enum KeyData {
    SHARED_PREFERENCES, ALBUM_NAME_LIST, ALBUM_DATA_LIST, ALBUM_PASSWORD, IMAGE_PATH_LIST, IMAGE_PATH_VIEW_LIST, HISTORY_SEARCH_IMAGE, HISTORY_SEARCH_ALBUM, FAVORITE_LIST, TRASH_LIST, UN_AVAILABLE_IMAGE, DARK_MODE, CURRENT_FRAGMENT, LIST_IMAGE_VIEW, LANGUAGE_CURRENT, PATH_CURRENT_IMAGE_VIEW;
